 ...
 //MENU QUE PARA RECARGAR O AGREGAR CUENTA 
  if (opc == 2 && contador > 0 && Cverificacion == true && subopc == 0){
    ...
    if (kye2){
      ...
      case '3': 
        lcd.clear(); CverificacionPrint = true; cr(); lcd.print("CUENTAS PRINT"); digitalWrite(LedC , HIGH); delay(500);digitalWrite(LedC , LOW); band_default(); lcd.clear(); ;break;
      ...
      case '0': 
        estadotiempo = false; lcd.clear(); cr(); lcd.print  ("CLEAR DATOS"); delay(500); lcd.clear(); preferences.begin("my-app", false); preferences.clear(); preferences.end(); break;
